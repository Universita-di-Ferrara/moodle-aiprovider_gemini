...
$string['apikey'] = 'Gemini API key (legacy)';
$string['apikey_desc'] = 'Single API key. If "API keys (multi-key)" above is set, this field is ignored. Get a key from <a href="https://aistudio.google.com/apikey">Google AI Studio website API keys</a>.';
$string['apikeys'] = 'API keys (multi-key failover)';
$string['apikeys_desc'] = 'Enter one API key per line. The first key is used by default. On rate limit (429) or authentication errors (401/403), the provider automatically switches to the next key. Get keys from <a href="https://aistudio.google.com/apikey">Google AI Studio website API keys</a>.';
...
$string['getallmodels_error'] = 'You need to insert at least one API key before.';
