...
$string['apikey_desc'] = 'Your primary Gemini API key. Get a key from <a href="https://aistudio.google.com/apikey">Google AI Studio</a>.';
$string['apikey_fallback'] = 'Fallback API key';
$string['apikey_fallback_desc'] = 'Optional. Used only when the primary key fails with an authentication error (401/403), e.g. if it has been revoked or rotated. This key must be from the same Google Cloud project (rate limits are per-project, not per-key).';
