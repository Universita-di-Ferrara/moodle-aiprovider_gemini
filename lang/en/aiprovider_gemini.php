...
$string['action:generate_image:model_desc'] = 'The Gemini native image model used to generate images from user prompts.';
$string['action:generate_text:endpoint'] = 'API endpoint';
$string['action:generate_text:model'] = 'AI model';
$string['action:generate_text:model_desc'] = 'The stable Gemini model used to generate the text response. Gemini 3 models use the Interactions API.';
...
$string['action:summarise_text:model_desc'] = 'The stable Gemini model used to summarise the provided text. Gemini 3 models use the Interactions API.';
...
$string['endpoint_desc'] = 'For Gemini 3 and native image models use the Interactions endpoint. Existing legacy model configurations may continue to use their GenerateContent endpoint.';
...
$string['image_endpoint_unsupported'] = 'Native Gemini image generation requires the Interactions API endpoint. Update the provider endpoint in the site administration settings.';
$string['image_model_unsupported'] = 'The configured image model is no longer supported. Select a stable Gemini 3 native image model.';
$string['image_quality_unsupported'] = 'The selected image model supports 1K output only. Choose Standard quality or select another image model.';
$string['image_response_missing'] = 'The Gemini API response did not contain a generated image.';
